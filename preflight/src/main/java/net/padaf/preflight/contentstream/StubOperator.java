...
import static net.padaf.preflight.ValidationConstants.ERROR_SYNTAX_ARRAY_TOO_LONG;
import static net.padaf.preflight.ValidationConstants.ERROR_SYNTAX_CONTENT_STREAM_INVALID_ARGUMENT;
import static net.padaf.preflight.ValidationConstants.ERROR_SYNTAX_LITERAL_TOO_LONG;
import static net.padaf.preflight.ValidationConstants.ERROR_SYNTAX_NAME_TOO_LONG;
import static net.padaf.preflight.ValidationConstants.ERROR_SYNTAX_NUMERIC_RANGE;
import static net.padaf.preflight.ValidationConstants.ERROR_SYNTAX_TOO_MANY_ENTRIES;

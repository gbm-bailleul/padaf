...
import static net.padaf.preflight.ValidationConstants.ANNOT_DICTIONARY_KEY_CA;
import static net.padaf.preflight.ValidationConstants.ANNOT_DICTIONARY_KEY_D;
import static net.padaf.preflight.ValidationConstants.ANNOT_DICTIONARY_KEY_N;
import static net.padaf.preflight.ValidationConstants.ANNOT_DICTIONARY_KEY_R;
import static net.padaf.preflight.ValidationConstants.ANNOT_DICTIONARY_VALUE_SUBTYPE_POPUP;
import static net.padaf.preflight.ValidationConstants.ERROR_SYNTAX_DICT_INVALID;

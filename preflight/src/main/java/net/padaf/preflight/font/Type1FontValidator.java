...
public class Type1FontValidator extends SimpleFontValidator {
  ...
  protected boolean checkFontFileElement() throws ValidationException {
    ...
    boolean hasLength2 = stream.getInt(COSName
        .getPDFName(FONT_DICTIONARY_KEY_LENGTH2)) > 0;
    boolean hasLength3 = stream.getInt(COSName
        .getPDFName(FONT_DICTIONARY_KEY_LENGTH3)) > 0;

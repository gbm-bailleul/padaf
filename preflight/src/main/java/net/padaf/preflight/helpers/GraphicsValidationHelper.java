...
import net.padaf.preflight.graphics.TilingPattern;
import net.padaf.preflight.graphics.XObjFormValidator;
import net.padaf.preflight.graphics.XObjImageValidator;
import net.padaf.preflight.graphics.XObjPostscriptValidator;
import net.padaf.preflight.graphics.XObjectValidator;

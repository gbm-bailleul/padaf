...
public class XMPBasicTest extends AbstractXMPSchemaTest {
	...
	public static Collection<Object[]> initializeParameters() throws Exception {
		...
		data.add(wrapProperty("Advisory","bag Xpath", new String[]{"xpath1","xpath2"}));
		...
		data.add(wrapProperty("Identifier","bag Text",new String []{"id1","id2"}));
...
//		Assert.assertEquals("xmp:Advisory", schem.getAdvisory().getQualifiedName());
//		Assert.assertTrue(schem.getAdvisoryValues().contains(xpath1));
//		Assert.assertTrue(schem.getAdvisoryValues().contains(xpath2));
//
//		Assert.assertEquals("xmp:BaseURL", schem.getBaseURL().getQualifiedName());
//		Assert.assertEquals(url, schem.getBaseURLValue());
//
//		Assert.assertEquals("xmp:CreateDate", schem.getCreateDate().getQualifiedName());
//		Assert.assertEquals(createDate, schem.getCreateDateValue());
//
//		Assert.assertEquals("xmp:CreatorTool", schem.getCreatorTool().getQualifiedName());
//		Assert.assertEquals(creatorTool, schem.getCreatorToolValue());
//
//		Assert.assertEquals("xmp:Identifier", schem.getIdentifier().getQualifiedName());
...
//
//		Assert.assertEquals("xmp:MetadataDate", schem.getMetadataDate().getQualifiedName());
//		Assert.assertEquals(metaDataDate, schem.getMetadataDateValue());
//
//		Assert.assertEquals("xmp:ModifyDate", schem.getModifyDate().getQualifiedName());
//		Assert.assertEquals(modifyDate, schem.getModifyDateValue());
//
//		Assert.assertEquals("xmp:Nickname", schem.getNickname().getQualifiedName());

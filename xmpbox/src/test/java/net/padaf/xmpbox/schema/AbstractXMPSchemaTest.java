...
public abstract class AbstractXMPSchemaTest {
  ...
  public static Object[] wrapProperty (String name, String type, Object value) {
    if (type.equals("Boolean")) Assert.assertTrue(value instanceof Boolean);
    else if (type.equals("Text")) Assert.assertTrue(value instanceof String);
    else if (type.equals("Integer")) Assert.assertTrue(value instanceof Integer);
    else if (type.equals("Date")) Assert.assertTrue(value instanceof Calendar);
    else if (type.equals("URL")) Assert.assertTrue(value instanceof String);
      ...
      if (field.isAnnotationPresent(PropertyType.class)) {
        if (!field.get(schema).equals(property)) {
          ...
          if (pt.propertyType().equals("Lang Alt")) {
        	...
        	// type test
            String getName = "get"+firstUpper(field.get(schema).toString());
            Method getMethod = schemaClass.getMethod(getName);
            Assert.assertNull(getName+" should return null when testing "+property,getMethod.invoke(schema));
            // value test
  ...
  protected void testGetSetBooleanProperty () throws Exception {
	  ...
	  BooleanType bt = new BooleanType(metadata,schema.getLocalPrefix(),property,value);
  ...
  protected void testGetSetDateProperty () throws Exception {
	  ...
	  DateType dt = new DateType(metadata,schema.getLocalPrefix(),property,value);
  ...
  protected void testGetSetIntegerProperty () throws Exception {
	  ...
	  IntegerType it = new IntegerType(metadata,schema.getLocalPrefix(),property,value);
  ...
  protected void testGetSetTextProperty () throws Exception {
    ...
    TextType tt = new TextType(metadata,schema.getLocalPrefix(),property,value);

...
public class XMPMediaManagementTest extends AbstractXMPSchemaTest{
  ...
  public static Collection<Object[]> initializeParameters() throws Exception {
    ...
    data.add(wrapProperty("DocumentID","Text","uuid:FB031973-5E75-11B2-8F06-E7F5C101C07A"));
    ...
    data.add(wrapProperty("Versions","seq Text",new String[]{"1","2","3"}));
    data.add(wrapProperty("History","seq Text",new String[]{"action 1","action 2","action 3"}));
    data.add(wrapProperty("Ingredients","bag Text",new String[]{"resource1","resource2"}));
    return data;
  }

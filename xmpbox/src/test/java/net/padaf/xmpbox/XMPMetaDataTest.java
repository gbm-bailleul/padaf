...
public class XMPMetaDataTest {
	...
	public void init() throws Exception{
		...
		tmp.addProperty(new TextType(metadata, "test", "simpleProperty", "YEP"));
	...
	/*@Test
	public void displayResult() throws TransformException {
	...
	*/
	...
	@Test(expected=net.padaf.xmpbox.TransformException.class)
	...
	public void testInitMetaDataWithInfo() throws Exception{
		...
		metadata=new XMPMetadata(xpacketBegin, xpacketId, xpacketBytes, xpacketEncoding);
